...
Once the `conda-forge` channel has been enabled, `sphinx-tabs` can be installed with:

```
conda install sphinx-tabs
```

It is possible to list all of the versions of `sphinx-tabs` available on your platform with:
